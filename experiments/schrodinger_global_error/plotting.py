...
from method_definition import dlra_deim_names, dlra_names, dlra_deim_linestyles, dlra_linestyles, dlra_colors, dlra_deim_colors, dlra_legends, dlra_deim_legends
...
plt.loglog(stepsizes, best_error[-1] * np.ones(len(stepsizes)), 'k--', label='Best rank approximation')
