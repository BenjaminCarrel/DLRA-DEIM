...
#             'deim_kwargs': {}
#             }]
# dlra_deim_names += [rf'PRK2-DEIM']
# dlra_deim_legends += [rf'PRK2-DEIM']
# dlra_deim_linestyles += ['-']
# dlra_deim_colors += [colors[1]]
...
#             'deim_kwargs': {}
#             }]
# dlra_deim_names += [rf'PRK2-QDEIM']
# dlra_deim_legends += [rf'PRK2-QDEIM']
# dlra_deim_linestyles += ['-']
# dlra_deim_colors += [colors[1]]
...
#             'deim_kwargs': {}
#             }]
# dlra_deim_names += [rf'PRK2-sRRQR ($\eta=2$)']
...
#             'deim_kwargs': {}
#             }]
# dlra_deim_names += [rf'PRK2-ARP']
# dlra_deim_legends += [rf'PRK2-ARP']
# dlra_deim_linestyles += ['-']
# dlra_deim_colors += [colors[1]]
